...
if (!content.includes('import { CheckCircle')) {
  content = content.replace(
    ...
    "import { TIPOS } from '../data.js';\nimport { CheckCircle, Clock, Check, FileText, Download, X, AlertTriangle, MessageSquare, ChevronDown, ChevronUp, Trash2, Edit3, User, Search, MapPin, Landmark, CircleDollarSign, Route, Mail, Save, FileCheck, XCircle, ArrowRight, BookOpen, Send, ShieldAlert, Award, FileSpreadsheet, Paperclip } from 'lucide-react';"
  );
}
...
// Fix missing imports from previous replacement if needed
if (!content.includes('import { FolderOpen')) {
  content = content.replace(
    "import { CheckCircle",
    "import { FolderOpen, CheckCircle"
  );
}
